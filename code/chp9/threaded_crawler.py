...
from chp9.downloader import Downloader
...
def threaded_crawler(start_url, link_regex, user_agent='wswp', proxies=None,
    ...
    """ Crawl from the given start URLs following links matched by link_regex. In this
        ...
        kwargs:
            ...
            scraper_callback (func): function to call to parse html, it is passed the URL and HTML content (default: None)
    """
        ...
        while crawl_queue:
            ...
            if no_robots or rp.can_fetch(user_agent, url):
                ...
                if depth == max_depth:
                    ...
                    continue
                html, content = D(url, num_retries=num_retries)
                if not html:
                    continue
                if scraper_callback:
                    links = scraper_callback(url, content) or []
                else:
                    links = []
